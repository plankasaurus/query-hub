        ...
        <div className="space-y-12">
            ...
            <div className="text-center space-y-8 relative">
                ...
                <div className="relative">
                    <div className="inline-flex items-center space-x-2 px-4 py-2 rounded-full border border-border/50 bg-muted/50 backdrop-blur-sm text-sm text-muted-foreground mb-6">
                        ...
                        <span>Naturally query Australia's data</span>
                    </div>
            ...
            <div className="max-w-4xl mx-auto">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                    ...
                    <div className="text-center p-6 rounded-2xl bg-gradient-to-br from-cyan-500/10 to-green-500/10 border border-border/50 backdrop-blur-sm hover:scale-105 transition-transform duration-200">
                        ...
                        <div className="text-sm text-muted-foreground font-medium">Join dispersed datasets</div>
                    </div>
                ...
                <Link href="/query-builder" className="group">
                    <div className="p-8 rounded-2xl bg-gradient-to-br from-card to-card/50 border border-border/50 hover:border-purple-500/50 transition-colors duration-200 group-hover:shadow-2xl group-hover:shadow-purple-500/10 group-hover:-translate-y-1 backdrop-blur-sm">
                        <div className="flex items-center space-x-4 mb-6">
                            ...
                            <h3 className="text-2xl font-bold text-primary">Natural Language Querying</h3>
                        </div>
                        <p className="text-muted-foreground text-lg leading-relaxed">
                            Build complex queries with natural language, to gain insight across Australia's data.
                        </p>
            ...
            <div className="text-center space-y-6">
                <div className="inline-flex items-center space-x-2 px-6 py-3 rounded-full border border-border/50 bg-muted/50 backdrop-blur-sm text-sm text-muted-foreground">
                    ...
                    <Link href="/query-builder" className="group">
                        <span>Ask query-hub a question!</span>
                    </Link>
                </div>
                <p className="text-sm text-muted-foreground">
                    Seeded with data from the Australian Bureau of Statistics.
                </p>
            </div>
        </div>
    )
