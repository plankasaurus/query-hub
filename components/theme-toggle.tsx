    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button 
          variant="outline" 
          size="icon"
          className="relative w-10 h-10 rounded-xl border-border/50 bg-muted/50 backdrop-blur-sm hover:bg-muted/80 hover:border-border transition-colors duration-200 hover:scale-105"
        >
